<div>
    @if (Auth::check())
        ...
        @else
        <ul class="cart_items_list ul_li_block mb_30 clearfix mx-auto mt-4">
            <li>
                <h5 style="opacity: 50%">You have order anything yet</h5>
            </li>
        </ul>
        @endif
    ...
    @else
        <ul class="cart_items_list ul_li_block mb_30 clearfix mx-auto mt-4">
            <li>
                <h5 style="opacity: 50%">Need to login first</h5>
            </li>
        </ul>
    @endif
</div>
